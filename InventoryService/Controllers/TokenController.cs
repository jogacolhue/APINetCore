...
namespace InventoryService.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post(UserInfo _userData)
        {
            if (_userData != null && _userData.Email != null && _userData.Password != null)
            {
                ...
                if (user != null)
                {
                    ...
                    DatosToken resultado = new DatosToken()
                    {
        ...
        [Route("refresh")]
        [HttpPost]
        public async Task<IActionResult> Refresh(UserInfo _userData)
        {
            if (_userData != null && _userData.Email != null && _userData.RefreshToken != null)
            {
                var user = await _context.UserInfo.FirstOrDefaultAsync(u => u.Email == _userData.Email && u.RefreshToken == _userData.RefreshToken);
